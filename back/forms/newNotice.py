...
class NoticeImageForm(forms.ModelForm):
    class Meta:
        ...
        fields =['id','image']
        widgets ={
            'image':forms.ClearableFileInput(attrs={'class':'form-control','hidden':True,'required':False})
        }
...
class NoticeDocumentForm(forms.ModelForm):
    class Meta:
        ...
        fields =['id','document']
        widgets ={
            'document':forms.ClearableFileInput(attrs={'class':'form-control','hidden':True,'required':False})
        }
