...
urlpatterns =[
    ...
    path("delete-menu/<int:id>",views.deleteMenu,name="delete-menu"),
    path("edit-content-type/<int:id>",views.editContentType,name="edit-content-type"),
    path("delete-content-type/<int:id>",views.deleteContentType,name="delete-content-type"),
